...
# --- 데이터 ---
pre_stretch = {"name": "전신 스트레칭 (운동 전)", "https://youtu.be/ahbAnkN4KJ0?si=8bpv4KW5JuSP4oZ1"}
post_stretch = {"name": "전신 스트레칭 (운동 후)", "https://youtu.be/xW3JI2eI7nM?si=6zeKT1a6egU-ox_H"}

exercise_videos = {
    "전신": [
        {"name": "귀찮은 날, 전신 폭파", "https://youtu.be/F-Jd4kI6rdM?si=2kNyTBbgKWKQIWs4"},
    ],
    "상체": [
        {"name": "상체 전체 폭파", "https://youtu.be/54tTYO-vU2E?si=MomGozGJ9UT2K7hP"},
    ],
    "하체": [
        {"name": "하체 전체 폭파", "https://youtu.be/NDsjmxTROEo?si=Hybxtgpxu1QfIBhR"},
}
